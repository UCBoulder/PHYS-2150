...
class TestValidateCellNumber:
    ...
    def test_valid_cell_number(self, jv_experiment):
        """Valid 3-digit cell number should pass."""
    ...
    def test_cell_number_with_leading_zeros(self, jv_experiment):
        """Cell numbers with leading zeros should pass."""
        jv_experiment.params = {
            'cell_number': '001',
            'pixel_number': 1,
            'start_voltage': -0.2,
    ...
    def test_empty_cell_number_raises(self, jv_experiment):
        ...
        with pytest.raises(JVExperimentError, match="3-digit"):
            jv_experiment.validate_parameters()

    def test_two_digit_cell_number_raises(self, jv_experiment):
        """Two-digit cell number should raise error."""
        jv_experiment.params = {
            'cell_number': '12',
            'pixel_number': 1,
            'start_voltage': -0.2,
    ...
    def test_four_digit_cell_number_raises(self, jv_experiment):
        """Four-digit cell number should raise error."""
        jv_experiment.params = {
            'cell_number': '1234',
            'pixel_number': 1,
            'start_voltage': -0.2,
    ...
    def test_non_numeric_cell_number_raises(self, jv_experiment):
        """Non-numeric cell number should raise error."""
        jv_experiment.params = {
            'cell_number': 'abc',
            'pixel_number': 1,
            'start_voltage': -0.2,
